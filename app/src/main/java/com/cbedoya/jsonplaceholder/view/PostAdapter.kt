...
class PostAdapter(private val posts: List<PostModel>, private val clickListener: (PostModel) -> Unit): RecyclerView.Adapter<PostAdapter.PostViewHolder>() {
    ...
    inner class PostViewHolder(private val binding: ItemPostBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(post: PostModel, clickListener: (PostModel) -> Unit) {
